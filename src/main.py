...
def on_message(client: mqtt.Client, userdata, msg) -> None:
    ...
    try:
        ...
        logger.error(f"Received message from sensor that could not be converted to bool: {e}. Not doing inference")
        jar_present = False
...
def main():
    ...
    mqttc.connect_timeout = int(os.getenv("CONNECT_TIMEOUT"))
